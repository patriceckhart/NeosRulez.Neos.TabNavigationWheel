...
(0, _neosUiExtensibility2.default)('NeosRulez.Neos.TabNavigationWheel', {}, function (globalRegistry, _ref) {
    var frontendConfiguration = _ref.frontendConfiguration;

    var containerRegistry = globalRegistry.get('containers');
    var originalInspector = containerRegistry.get('RightSideBar/Inspector');
    containerRegistry.set('RightSideBar/Inspector', ExtendedInspector(originalInspector));
});

var ExtendedInspector = function ExtendedInspector(OriginalInspector) {
    return function (_PureComponent) {
        _inherits(extendedInspector, _PureComponent);

        function extendedInspector() {
            _classCallCheck(this, extendedInspector);

            return _possibleConstructorReturn(this, (extendedInspector.__proto__ || Object.getPrototypeOf(extendedInspector)).apply(this, arguments));
        }

        _createClass(extendedInspector, [{
            key: 'render',
            value: function render() {
                return _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'div',
                        { id: 'neos-ExtendedInspector', className: _styles2.default.extendedInspector },
                        _react2.default.createElement(OriginalInspector, null)
                    )
                );
            }
        }]);

        return extendedInspector;
...
module.exports = {"extendedInspector":"styles__extendedInspector___d7Ddy"};
